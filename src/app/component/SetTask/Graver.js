...
class Graver extends React.Component {
    ...
    componentWillMount() {
        this.props.getUsersFromGroupRequest(3).then((res) => {
           // console.log(this.props.users[3]);
...
function mapStateToProps(state) {
    return {
        ...
        employee: state.employee[3]
    };
}


export default connect(mapStateToProps,{getUsersFromGroupRequest}) (Graver);
